<?php
    ...
    if(empty($_REQUEST['hash'])) {
        ...
        $clientCheckResult = $mysqli->query("SELECT COUNT(id) FROM clients WHERE hash = '".$mysqli->real_escape_string($_REQUEST['hash'])."' AND in_send = '1'");
    ...
    <div class="container" style="height: 100%;">
        ...
        <div id="personalButtons">
            <div class="headerIcon">
                <a href='login.php'><img src='/img/system/login.png' title='Войти под своей учётной записью' id='loginIMG' onmouseover='changeIcon("loginIMG", "loginRed.png")' onmouseout='changeIcon("loginIMG", "login.png")' /></a>
            </div>
            <div id='searchBlock'>
...
<div id="page" style="margin-top: 80px;">
    ...
    <div id="topSection">
        ...
        <div id="breadCrumbs">
            <a href="/"><span class="breadCrumbsText">Главная</span></a> > <a href="unsubscribe.php?hash=<?= $_REQUEST['hash'] ?>"><span class="breadCrumbsText">Отписка от рассылки</span></a>
        </div>
    </div>

    <p><b>Внимание!</b> Отписка от нашей информационной рассылки повлечёт за собой аннулирование вашей персональной скидки (скидки вашего предприятия)!</p>
    <input type="button" class="buttonRelative" value="Отписаться от рассылки" id="unsubscribeButton" onmouseover="buttonChange('unsubscribeButton', 1)" onmouseout="buttonChange('unsubscribeButton', 0)" onclick="unsubscribe('<?= $_REQUEST['hash'] ?>')" />
    <br /><br />
    <p><a href="/">Вернуться на главную страницу</a><br /><a href="/catalogue/index.php?type=fa">Перейти в каталог</a></p>
