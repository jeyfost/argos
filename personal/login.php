...
<body>
			...
			<div id="personalButtons">
				<?php
					if(empty($_SESSION['userID'])) {
						...
						echo "<a href='../scripts/logout.php'><img src='../img/system/exitRed.png' title='Выйти из своей учётной записи' id='exitIMG' onmouseover='changeIcon(\"exitIMG\", \"exit.png\", 1)' onmouseout='changeIcon(\"exitIMG\", \"exitRed.png\", 1)' /></a>";
					}
				?>
			</div>
            <div id="menuLinks">
	...
	<div id="centralBlock">
		<div id="topSection">
			...
			<div id="breadCrumbs">
				<a href="../index.php"><span class="breadCrumbsText">Гавная</span></a> > <a href="login.php"><span class="breadCrumbsText">Вход в учётную запись</span></a>
			</div>
		</div>
		...
		<form id="loginForm" method="post" action="../scripts/login.php" onsubmit="return loginCheck();">
