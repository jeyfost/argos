        ...
        switch(id) {
            case "catalogueLink":
				...
				if(highlighted === "catalogueLinkCA") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #df4e47;'><a href='../catalogue/index.php?type=ca&p=1' id='catalogueLinkCAA' style='color: #fff'>Аксессуары для штор</a></div>");
				} else {
				...
				if(highlighted === "catalogueLinkHT") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #df4e47;'><a href='../catalogue/index.php?type=ht&p=1' id='catalogueLinkHTA' style='color: #fff'>Ручной инструмент</a></div>");
				} else {
				...
				if(highlighted === "catalogueLinkDG") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #df4e47;'><a href='../catalogue/index.php?type=dg&p=1' id='catalogueLinkDGA' style='color: #fff'>Сопутствующие товары</a></div>");
				} else {
            ...
            case "aboutLink":
				if(highlighted === "aboutLinkCommon") {
					$('#dropDownList').html("<div class='dropDownLink' style='background-color: #df4e47;'><a href='../about/info.php' id='aboutLinkCommonA' style='color: #fff;'>Общая информация</a></div>");
				} else {
				...
				if(highlighted === "aboutLinkAssortment") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #df4e47;'><a href='../about/assortment.php' id='aboutLinkAssortmentA' style='color: #fff;'>Ассортимент</a></div>");
				} else {
				...
				if(highlighted === "aboutLinkAwards") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #df4e47;'><a href='../about/awards.php' id='aboutLinkAwardsA' style='color: #fff;'>Достижения и награды</a></div>");
				} else {
				...
				if(highlighted === "aboutLinkVacancies") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #df4e47;'><a href='../about/vacancies.php' id='aboutLinkVacanciesA' style='color: #fff;'>Вакансии</a></div><div style='clear: both;'></div>");
				} else {
            ...
            case "storesLink":
				if(highlighted === "storesLinkCompany") {
					$('#dropDownList').html("<div class='dropDownLink' style='background-color: #df4e47;'><a href='../stores/company.php' id='storesLinkCompanyA' style='color: #fff;'>Фирменная сеть</a></div>");
				} else {
				...
				if(highlighted === "storesLinkRepresentatives") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #df4e47;'><a href='../stores/representatives.php' id='storesLinkRepresentativesA' style='color: #fff;'>Партнёрская сеть</a></div><div style='clear: both;'></div>");
				} else {
            ...
            case "contactsLink":
                if(highlighted === "contactsLinkStores") {
					$('#dropDownList').html("<div class='dropDownLink' style='background-color: #df4e47;'><a href='../contacts/stores.php' id='contactsLinkStoresA' style='color: #fff;'>Магазины</a></div>")
				} else {
				...
				if(highlighted === "contactsLinkMain") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #df4e47;'><a href='../contacts/main.php' id='contactsLinkMainA' style='color: #fff;'>Головное предприятие</a></div>");
				} else {
				...
				if(highlighted === "contactsLinkMail") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #df4e47;'><a href='../contacts/mail.php' id='contactsLinkMailA' style='color: #fff;'>Обратная связь</a></div><div style='clear: both;'></div>");
				} else {
