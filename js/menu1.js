        ...
        switch(id) {
            case "catalogueLink":
				...
				if(highlighted === "catalogueLinkCA") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #ff282b;'><a href='/catalogue/index.php?type=ca&p=1' id='catalogueLinkCAA' style='color: #fff'>Аксессуары для штор</a></div>");
				} else {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' id='catalogueLinkCA' onmouseover='changeDropDownLink(\"1\", \"catalogueLinkCA\", \"catalogueLinkCAA\")' onmouseout='changeDropDownLink(\"0\", \"catalogueLinkCA\", \"catalogueLinkCAA\")'><a href='/catalogue/index.php?type=ca&p=1' id='catalogueLinkCAA'>Аксессуары для штор</a></div>");
				}

				if(highlighted === "catalogueLinkHT") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #ff282b;'><a href='/catalogue/index.php?type=ht&p=1' id='catalogueLinkHTA' style='color: #fff'>Ручной инструмент</a></div>");
				} else {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' id='catalogueLinkHT' onmouseover='changeDropDownLink(\"1\", \"catalogueLinkHT\", \"catalogueLinkHTA\")' onmouseout='changeDropDownLink(\"0\", \"catalogueLinkHT\", \"catalogueLinkHTA\")'><a href='/catalogue/index.php?type=ht&p=1' id='catalogueLinkHTA'>Ручной инструмент</a></div>");
				}

				if(highlighted === "catalogueLinkDG") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #ff282b;'><a href='/catalogue/index.php?type=dg&p=1' id='catalogueLinkDGA' style='color: #fff'>Сопутствующие товары</a></div>");
				} else {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' id='catalogueLinkDG' onmouseover='changeDropDownLink(\"1\", \"catalogueLinkDG\", \"catalogueLinkDGA\")' onmouseout='changeDropDownLink(\"0\", \"catalogueLinkDG\", \"catalogueLinkDGA\")'><a href='/catalogue/index.php?type=dg&p=1' id='catalogueLinkDGA'>Сопутствующие товары</a></div>");
				}
            ...
            case "aboutLink":
				if(highlighted === "aboutLinkCommon") {
					$('#dropDownList').html("<div class='dropDownLink' style='background-color: #ff282b;'><a href='/about/info.php' id='aboutLinkCommonA' style='color: #fff;'>Общая информация</a></div>");
				} else {
				...
				if(highlighted === "aboutLinkAssortment") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #ff282b;'><a href='/about/assortment.php' id='aboutLinkAssortmentA' style='color: #fff;'>Ассортимент</a></div>");
				} else {
				...
				if(highlighted === "aboutLinkAwards") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #ff282b;'><a href='/about/awards.php' id='aboutLinkAwardsA' style='color: #fff;'>Достижения и награды</a></div>");
				} else {
				...
				if(highlighted === "aboutLinkGallery") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #ff282b;'><a href='/about/gallery.php' id='aboutLinkGalleryA' style='color: #fff;'>Фотогалерея</a></div>");
				} else {
				...
				if(highlighted === "aboutLinkVacancies") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #ff282b;'><a href='/about/vacancies.php' id='aboutLinkVacanciesA' style='color: #fff;'>Вакансии</a></div><div style='clear: both;'></div>");
				} else {
                ...
                break;
            case "storesLink":
				if(highlighted === "storesLinkCompany") {
					$('#dropDownList').html("<div class='dropDownLink' style='background-color: #ff282b;'><a href='/stores/company.php' id='storesLinkCompanyA' style='color: #fff;'>Фирменная сеть</a></div>");
				} else {
					$('#dropDownList').html("<div class='dropDownLink' id='storesLinkCompany' onmouseover='changeDropDownLink(\"1\", \"storesLinkCompany\", \"storesLinkCompanyA\")' onmouseout='changeDropDownLink(\"0\", \"storesLinkCompany\", \"storesLinkCompanyA\")'><a href='/stores/company.php' id='storesLinkCompanyA'>Фирменная сеть</a></div>");
				}

				if(highlighted === "storesLinkRepresentatives") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #ff282b;'><a href='/stores/representatives.php' id='storesLinkRepresentativesA' style='color: #fff;'>Партнёрская сеть</a></div><div style='clear: both;'></div>");
				} else {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' id='storesLinkRepresentatives' onmouseover='changeDropDownLink(\"1\", \"storesLinkRepresentatives\", \"storesLinkRepresentativesA\")' onmouseout='changeDropDownLink(\"0\", \"storesLinkRepresentatives\", \"storesLinkRepresentativesA\")'><a href='/stores/representatives.php' id='storesLinkRepresentativesA'>Партнёрская сеть</a></div><div style='clear: both;'></div>");
				}
                break;
            case "partnersLink":
				if(highlighted === "partnersLinkCooperation") {
					$('#dropDownList').html("<div class='dropDownLink' style='background-color: #ff282b;'><a href='/partners/cooperation.php' id='partnersLinkCooperationA' style='color: #fff;'>Сотрудничество</a></div>");
				} else {
				...
				if(highlighted === "partnersLinkClientNews") {
					$('#dropDownList').html($('#dropDownList').html() +"<div class='dropDownLink' style='background-color: #ff282b;'><a href='/partners/news.php' id='partnersLinkClientNewsA' style='color: #fff;'>Новости для клиентов</a></div><div style='clear: both;'></div>");
				} else {
            ...
            case "contactsLink":
                if(highlighted === "contactsLinkStores") {
					$('#dropDownList').html("<div class='dropDownLink' style='background-color: #ff282b;'><a href='/contacts/stores.php' id='contactsLinkStoresA' style='color: #fff;'>Торговые объекты</a></div>")
				} else {
				...
				if(highlighted === "contactsLinkMain") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #ff282b;'><a href='/contacts/main.php' id='contactsLinkMainA' style='color: #fff;'>Головное предприятие</a></div>");
				} else {
				...
				if(highlighted === "contactsLinkMail") {
					$('#dropDownList').html($('#dropDownList').html() + "<div class='dropDownLink' style='background-color: #ff282b;'><a href='/contacts/mail.php' id='contactsLinkMailA' style='color: #fff;'>Обратная связь</a></div><div style='clear: both;'></div>");
				} else {
...
function showSearchList() {
	if($('#searchFieldInput').val() !== "Поиск..." && $('#searchFieldInput').val() !== "") {
		$.ajax({
			...
			url: "/scripts/personal/ajaxSearch.php",
