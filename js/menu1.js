        ...
        switch(id) {
            ...
            case "contactsLink":
                if(highlighted === "contactsLinkStores") {
					$('#dropDownList').html("<div class='dropDownLink' style='background-color: #ff282b;'><a href='/contacts/stores.php' id='contactsLinkStoresA' style='color: #fff;'>Магазины</a></div>")
				} else {
