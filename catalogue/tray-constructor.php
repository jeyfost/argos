...
<head>
    ...
    <meta charset="utf-8">
    <meta name='description' content='Онлайн-конструктор наборных вкладышей для выдвижных ящиков.'>

    <title>Аргос-ФМ | Онлайн-конструктор наборных вкладышей для выдвижных ящиков</title>
    ...
    <script type="text/javascript" src="/js/tray-constructor.js"></script>
...
<div id="menu">
    <div class="container" style="height: 100%;">
        ...
        <div id="menuLinks">
            <div class="menuLink" id="catalogueLink" <?php echo "onmouseover='showDropdownList(\"1\", \"catalogueLink\", \"\")'"; ?>>
...
<div id="page">
    ...
    <h1 style='margin-top: 80px;'>Онлайн-конструктор наборных вкладышей для выдвижных ящиков</h1>
    <div id='breadCrumbs'>
        <a href='/'><span class='breadCrumbsText'>Главная</span></a> > <a href='index.php?type=fa&p=1'><span class='breadCrumbsText'>Каталог</span></a> > <a href='tray-constructor.php'><span class='breadCrumbsText'>Онлайн-конструктор наборных вкладышей для выдвижных ящиков</span></a>
    </div>

    <div id="catalogueMenu">
        <?php
        $typesResult = $mysqli->query("SELECT * FROM types ORDER BY id");
        $i = 0;
