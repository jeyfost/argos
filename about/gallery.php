...
<head>
 	<meta charset="utf-8">
 	<meta name="description" content="Компания Аргос-ФМ ежегодно принимает участие в различных международных и местных специализированных выставках, форумах и семинарах в области мебельной фурнитуры. Здесь вы можете посмотреть фотографии, сделанные как на этих мероприятиях, так и фотографии из жизни нашей компании.">

    <title>Аргос-ФМ | Фотогалерея</title>
...
<body>
	...
	<div id="page">
		...
		<div id='breadCrumbs'>
			<a href='/'><span class='breadCrumbsText'>Главная</span></a> > <a href='info.php'><span class='breadCrumbsText'>О компании</span></a> > <a href='gallery.php'><span class='breadCrumbsText'>Фотогалерея</span></a>
		</div>
