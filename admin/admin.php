...
<body style="background-color: #e4e4e4;">
	...
	<div id="content">
		...
		<br />
		<div id="admContent">
			<div id="breadCrumbs"><div id="breadCrumbsIcon"><img src="../img/system/admin/icons/home.png" title="Панель администрирования" /></div><div id="breadCrumbsTextContainer"><a href="admin.php"><span class="breadCrumbsText">Панель администрирования</span></a></div></div>
			<div style="clear: both;"></div>
			<br />
			<h2>&larr; Для продолжения работы выберите раздел</h2>
		</div>
		<div style="clear: both;"></div>
	</div>
