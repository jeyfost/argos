...
<body style="background-color: #e4e4e4;">
	...
	<div id="content">
		...
		<div id="admContent">
			...
			?>
			<div id="breadCrumbs"><div id="breadCrumbsIcon"><img src="/img/system/admin/icons/product.png" title="Товары" /></div><div id="breadCrumbsTextContainer"><a href="/admin/admin.php"><span class="breadCrumbsText">Панель администрирования</span></a> > <a href="index.php"><span class="breadCrumbsText">Товары</span></a> > <a href="edit.php"><span class="breadCrumbsText">Удаление товаров</span></a><?php if(!empty($_REQUEST['id'])) {echo " > <a href='".$_SERVER['REQUEST_URI']."'><span class='breadCrumbsText'>".$goodName[0]."</span></a>";} ?></div></div>
			<div style="clear: both;"></div>
			<br />
