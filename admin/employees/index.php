...
<body style="background-color: #e4e4e4;">
    ...
    <div id="content">
        ...
        <div id="admContent">
            ...
            <a href="delete.php"><input type="button" class="button" id="inactiveButton" value="Удаление" onmouseover="buttonChange('deleteButton', 1)" onmouseout="buttonChange('deleteButton', 0)" /></a>
            <div style="clear: both;"></div>
        </div>
        <div style="clear: both;"></div>
    </div>
