...
<head>
    ...
    <script type="text/javascript" src="/js/admin/employees/list.js"></script>
            ...
            <table>
                ...
                <?php
                    ...
                    while($employee = $employeeResult->fetch_assoc()) {
                        ...
                        echo "
                            <tr id='tr".$i."' onmouseover='searchItemHover(\"tr".$i."\", 1, \"".$i."\")' onmouseout='searchItemHover(\"tr".$i."\", 0, \"".$i."\")'>
                                <td>".$i."</td>
                                <td>".$employee['full_name']."</td>
                                <td>".$employee['name']."</td>
                                <td>".$employee['position']."</td>
                                <td>".$employee['phone']."</td>
                                <td style='text-align: center;'><a href='edit.php?id=".$employee['id']."'><span class='redLink' style='font-size: 14px;'>Редактировать</span></a></td>
                            </tr>
                        ";
                    }
                ?>
