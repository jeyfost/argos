...
<head>
	...
	<script type="text/javascript" src="/js/admin/vacancies/add.js"></script>
...
<body style="background-color: #e4e4e4;">
	...
	<div id="content">
		...
		<br />
		<div id="admContent">
			<div id="breadCrumbs"><div id="breadCrumbsIcon"><img src="/img/system/admin/icons/vacancy.png" title="Вакансии" /></div><div id="breadCrumbsTextContainer"><a href="/admin/admin.php"><span class="breadCrumbsText">Панель администрирования</span></a> > <a href="index.php"><span class="breadCrumbsText">Вакансии</span></a> > <a href="add.php"><span class="breadCrumbsText">Добавление вакансий</span></a></div></div>
			<div style="clear: both;"></div>
			<br />
			<h2>Добавление вакансий</h2>
			...
			<form id="addForm" method="post">
				...
				<br /><br />
				<input type='button' class='button' style='margin: 0;' id='addVacancyButton' onmouseover='buttonChange("addVacancyButton", 1)' onmouseout='buttonChange("addVacancyButton", 0)' onclick='addVacancy()' value='Добавить' />
			</form>
			<div style="clear: both;"></div>
		</div>
		<div style="clear: both;"></div>
