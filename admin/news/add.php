...
<body style="background-color: #e4e4e4;">
	...
	<div id="content">
		...
		<br />
		<div id="admContent">
			<div id="breadCrumbs"><div id="breadCrumbsIcon"><img src="/img/system/admin/icons/rss.png" title="Новости" /></div><div id="breadCrumbsTextContainer"><a href="/admin/admin.php"><span class="breadCrumbsText">Панель администрирования</span></a> > <a href="index.php"><span class="breadCrumbsText">Новости</span></a> > <a href="add.php"><span class="breadCrumbsText">Добавление новостей</span></a></div></div>
			<div style="clear: both;"></div>
			<br />
			...
			<form id="addForm" method="post" enctype="multipart/form-data">
				...
				<br />
				<input type='button' class='button' style='margin: 0;' id='addNewsButton' onmouseover='buttonChange("addNewsButton", 1)' onmouseout='buttonChange("addNewsButton", 0)' onclick='addNews()' value='Добавить' />
			</form>
			<div style="clear: both;"></div>
		</div>
		<div style="clear: both;"></div>
