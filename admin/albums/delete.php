...
<head>
	...
	<script type="text/javascript" src="/js/admin/albums/delete.js"></script>
...
<body style="background-color: #e4e4e4;">
	...
	<div id="content">
		...
		<br />
		<div id="admContent">
			<div id="breadCrumbs"><div id="breadCrumbsIcon"><img src="/img/system/admin/icons/album.png" title="Альбомы" /></div><div id="breadCrumbsTextContainer"><a href="/admin/admin.php"><span class="breadCrumbsText">Панель администрирования</span></a> > <a href="index.php"><span class="breadCrumbsText">Альбомы</span></a> > <a href="delete.php"><span class="breadCrumbsText">Удаление альбомов</span></a></div></div>
			<div style="clear: both;"></div>
			<br />
			...
			<form id="deleteForm" method="post">
				...
				<br />
				<select id="albumSelect" name="album" onchange="window.location = 'delete.php?id=' + this.options[this.selectedIndex].value">
				...
				<?php
					if(!empty($_REQUEST['id'])) {
						echo "
							<br /><br />
							<input type='button' class='button' style='margin: 0;' id='deleteAlbumButton' onmouseover='buttonChange(\"deleteAlbumButton\", 1)' onmouseout='buttonChange(\"deleteAlbumButton\", 0)' onclick='deleteAlbum()' value='Удалить' />
						";
					}
				?>
			</form>
