...
<html>
    ...
    <head>
        ...
        <title>Удаление типа ручек</title>
        ...
        <script type="text/javascript" src="/js/admin/filters/types/delete.js"></script>
    ...
    <div id="content">
        ...
        <div id="admContent">
            ...
            <form id="deleteForm" method="post">
                ...
                <br />
                <select id="typeSelect" name="type" onchange="window.location = 'delete.php?id=' + this.options[this.selectedIndex].value">
                ...
                if(!empty($_REQUEST['id'])) {
                    echo "
                                        <br /><br />
                                        <input type='button' class='button' style='margin: 0' id='deleteTypeButton' onmouseover='buttonChange(\"deleteTypeButton\", 1)' onmouseout='buttonChange(\"deleteTypeButton\", 0)' onclick='deleteType()' value='Удалить' />
                                    ";
                }
                ?>
            </form>
