...
<html>
    ...
    <head>
        ...
        <title>Добавление типа ручек</title>
        ...
        <script type="text/javascript" src="/js/admin/filters/types/add.js"></script>
