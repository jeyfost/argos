...
<div id="content">
    ...
    <div id="admContent">
        ...
        <a href="add.php"><input type="button" class="button" id="addButton" value="Установка" onmouseover="buttonChange('addButton', 1)" onmouseout="buttonChange('addButton', 0)" style="margin-left: 0;" /></a>
