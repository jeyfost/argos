...
<head>
    ...
    <title>Удаление материалов ручек</title>
    ...
    <script type="text/javascript" src="/js/admin/filters/materials/delete.js"></script>
...
<div id="content">
    ...
    <div id="admContent">
        ...
        <form id="deleteForm" method="post">
            ...
            <br />
            <select id="materialSelect" name="material" onchange="window.location = 'delete.php?id=' + this.options[this.selectedIndex].value">
            ...
            if(!empty($_REQUEST['id'])) {
                echo "
                        <br /><br />
                        <input type='button' class='button' style='margin: 0' id='deleteMaterialButton' onmouseover='buttonChange(\"deleteMaterialButton\", 1)' onmouseout='buttonChange(\"deleteMaterialButton\", 0)' onclick='deleteMaterial()' value='Удалить' />
                                        ";
            }
            ?>
        </form>
