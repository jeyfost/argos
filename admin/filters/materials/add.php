...
<head>
    ...
    <title>Добавление материалов ручек</title>
    ...
    <script type="text/javascript" src="/js/admin/filters/materials/add.js"></script>
...
<div id="content">
    ...
    <div id="admContent">
        ...
        <form id="addForm" method="post">
            <label for="materialInput">Материал:</label>
            <br />
            <input type="text" id="materialInput" />
            <br /><br />
            <input type="button" class="button" style="margin: 0" id="addMaterialButton" onmouseover='buttonChange("addMaterialButton", 1)' onmouseout='buttonChange("addMaterialButton", 0)' onclick='addMaterial()' value='Добавить' />
        </form>
        <div style="clear: both;"></div>
    </div>
    <div style="clear: both;"></div>
