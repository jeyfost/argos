...
<body style="background-color: #e4e4e4;">
	...
	<div id="content">
		...
		<div id="admContent">
			...
			<a href="/admin/filters/types/"><input type="button" class="button" id="typeButton" value="Типи ручек" onmouseover="buttonChange('typeButton', 1)" onmouseout="buttonChange('typeButton', 0)" /></a>
