...
<head>
    ...
    <title>Удаление цветов ручек</title>
    ...
    <script type="text/javascript" src="/js/admin/filters/colors/delete.js"></script>
...
<div id="content">
    ...
    <div id="admContent">
        ...
        <a href="delete.php"><input type="button" class="buttonActive" value="Удаление" /></a>
        <div style="clear: both;"></div>
        <br /><br />
        <form id="deleteForm" method="post">
            <label for="colorSelect">Выберите цвет ручек:</label>
            <br />
            <select id="colorSelect" name="color" onchange="window.location = 'delete.php?id=' + this.options[this.selectedIndex].value">
            ...
            <?php
                if(!empty($_REQUEST['id'])) {
                    echo "
                        <br /><br />
                        <input type='button' class='button' style='margin: 0' id='deleteColorButton' onmouseover='buttonChange(\"deleteColorButton\", 1)' onmouseout='buttonChange(\"deleteColorButton\", 0)' onclick='deleteColor()' value='Удалить' />
                                        ";
                }
            ?>
        </form>
