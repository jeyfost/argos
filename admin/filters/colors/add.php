...
<head>
    ...
    <title>Добавление цветов ручек</title>
    ...
    <script type="text/javascript" src="/js/admin/filters/colors/add.js"></script>
...
<div id="content">
    ...
    <div id="admContent">
        ...
        <form id="addForm" method="post">
            ...
            <br /><br />
            <input type="button" class="button" style="margin: 0" id="addColorButton" onmouseover='buttonChange("addColorButton", 1)' onmouseout='buttonChange("addColorButton", 0)' onclick='addColor()' value='Добавить' />
        </form>
        <div style="clear: both;"></div>
    </div>
    <div style="clear: both;"></div>
