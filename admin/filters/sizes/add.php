...
<head>
    ...
    <title>Добавление размеров ручек</title>
    ...
    <script type="text/javascript" src="/js/admin/filters/sizes/add.js"></script>
...
<div id="content">
    ...
    <div id="admContent">
        ...
        <form id="addForm" method="post">
            ...
            <br />
            <input type="number" id="sizeInput" min="1" step="1" />
            <br /><br />
            <input type="button" class="button" style="margin: 0" id="addSizeButton" onmouseover='buttonChange("addSizeButton", 1)' onmouseout='buttonChange("addSizeButton", 0)' onclick='addSize()' value='Добавить' />
        </form>
        <div style="clear: both;"></div>
    </div>
    <div style="clear: both;"></div>
