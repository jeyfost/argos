...
<head>
    ...
    <title>Удаление размеров ручек</title>
    ...
    <script type="text/javascript" src="/js/admin/filters/sizes/delete.js"></script>
...
<div id="content">
    ...
    <div id="admContent">
        ...
        <form id="deleteForm" method="post">
            ...
            <br />
            <select id="sizeSelect" name="size" onchange="window.location = 'delete.php?id=' + this.options[this.selectedIndex].value">
            ...
            <?php
                if(!empty($_REQUEST['id'])) {
                    echo "
                        <br /><br />
                        <input type='button' class='button' style='margin: 0' id='deleteSizeButton' onmouseover='buttonChange(\"deleteSizeButton\", 1)' onmouseout='buttonChange(\"deleteSizeButton\", 0)' onclick='deleteSize()' value='Удалить' />
                                        ";
                }
            ?>
        </form>
