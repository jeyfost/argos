...
if(!empty($_REQUEST['id'])) {
    $brandCheckResult = $mysqli->query("SELECT COUNT(id) FROM handles_brands WHERE id = '".$mysqli->real_escape_string($_REQUEST['id'])."'");
    $brandCheck = $brandCheckResult->fetch_array(MYSQLI_NUM);
}
...
<html>
    ...
    <head>
        ...
        <script type="text/javascript" src="/js/admin/filters/brands/delete.js"></script>
    ...
    <div id="content">
        ...
        <div id="admContent">
            ...
            <form id="deleteForm" method="post">
                ...
                <br />
                <select id="brandSelect" name="brand" onchange="window.location = 'delete.php?id=' + this.options[this.selectedIndex].value">
                ...
                <?php
                    if(!empty($_REQUEST['id'])) {
                        echo "
                                    <br /><br />
                                    <input type='button' class='button' style='margin: 0' id='deleteBrandButton' onmouseover='buttonChange(\"deleteBrandButton\", 1)' onmouseout='buttonChange(\"deleteBrandButton\", 0)' onclick='deleteBrand()' value='Удалить' />
                                ";
                    }
                    ?>
            </form>
