...
$searchResult = $mysqli->query("SELECT * FROM orders_info WHERE (id LIKE '%".$query."%' OR send_date LIKE '%".$query."%') AND user_id = '".$_SESSION['userID']."' AND status = '1' ORDER BY id LIMIT 10");
