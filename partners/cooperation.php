...
<head>
 	<meta charset="utf-8">
 	<meta name="description" content="Для того, чтобы начать сотрудничать с компанией Аргос-ФМ и получить персональные скидки на продукцию, ознакомтесь с условиями работы с нашей компанией.">

    <title>Аргос-ФМ | Условия сотрудничества</title>
...
<body>
    ...
    <div id="menu">
        <div class="container" style="height: 100%;">
			...
			<div id="menuLinks">
				...
				<div class="menuLink" id="partnersLink" onmouseover="showDropdownList('1', 'partnersLink', 'partnersLinkCooperation')">
	...
	<div id="page">
		...
		<h1 style='margin-top: 80px;'>Условия сотрудничества</h1>
		<div id='breadCrumbs'>
			<a href='/'><span class='breadCrumbsText'>Главная</span></a> > <a href='cooperation.php'><span class='breadCrumbsText'>Партнёрам</span></a> > <a href='cooperation.php'><span class='breadCrumbsText'>Сотрудничество</span></a>
		</div>

		<div id="personalMenu">
			<a href='cooperation.php'><div class='personalMenuLinkActive'>Сотрудничество</div></a>
			<div style='width: 100%; height: 5px;'></div>
			<a href='news.php'><div class='personalMenuLink' id='pbl2' onmouseover='buttonChange("pbl2", 1)' onmouseout='buttonChange("pbl2", 0)'>Новости для клиентов</div></a>
		</div>

		<div id="personalContent" style="text-align: justify;">
            <p>Компания <span style="color: #fe2427;"><b>«Аргос-ФМ»</b></span> сотрудничает как с самыми крупными мебельными предприятиями, так и с производителями мебели по индивидуальным заказам, а также с розничными покупателями через <a href="/stores/company.php">сеть собственных торговых объектов</a>. Мы стремимся поддерживать мебельное производство в Республике Беларусь и способствовать его развитию, поэтому для каждого производителя мебели, будь то крупная мебельная фабрика или индивидуальный предприниматель, действует система скидок.</p>
            <p>Для получения скидки юридическими лицами и индивидуальными предпринимателями, являющихся производителями мебели или занятыми в сфере торговли мебельной фурнитурой, <b><u>необходимо получить дисконтную карту</u></b>. Для получения дисконтной карты обращайтесь к нашим менеджерам (номера телефонов указаны в <a href="/contacts/main.php">разделе контактной информации</a>) или оставляйте заявку через <a href="/contacts/mail.php">раздел обратной связи</a>.</p>
            <p>Помимо индивидуальных скидок компания <span style="color: #fe2427;"><b>«Аргос-ФМ»</b></span> проводит различные <a href="/actions.php">акции</a>, по условиям которых Ваше предприятие может получить дополнительные скидки на различные виды товаров.</p>
            <p>Компания <span style="color: #fe2427;"><b>«Аргос-ФМ»</b></span> работает не только по предоплате, но и с рассрочкой платежа. Условия рассрочки всегда прописываются в договоре и рассматриваются индивидуально. Для получения рассрочки индивидуальным производителям мебели необходимо иметь хорошую кредитную историю с нашей компанией.</p>
            <p>Для Вашего удобства у нас работает система бесплатной доставки Вашего заказа в любую точку Республики Беларусь. Мы всегда рады плодотворному сотрудничеству!</p>
		</div>
	</div>
