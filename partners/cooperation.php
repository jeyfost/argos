...
<body>
	...
	<div id="page">
		...
		<div id="personalContent">
            ...
            <p>Для получения скидки <b><u>необходимо быть подписанным и читать нашу информационную рассылку</u></b>. Для включения Вашего предприятия в системную рассылку обращайтесь к нашим менеджерам (номера телефонов указаны в <a href="/contacts/main.php">разделе контактной информации</a>) или оставляйте заявку через <a href="/contacts/mail.php">раздел обратной связи</a>.</p>
